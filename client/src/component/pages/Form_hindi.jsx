...
const AudioRecorder = () => {
    ...
    return ( <
        ...
        <
        div className = "text-4xl md:text-6xl font-bold mb-6 md:mb-8 text-center" > { categoryData[currentCardIndex].hindi } <
        /div> <
        div className = "flex flex-col md:flex-row justify-between items-center mb-4" >
        <
        div className = "pronunciation text-base md:text-lg mb-2 md:mb-0" >
        <
        span className = "font-semibold" > Pronunciation: < /span>{" "} { categoryData[currentCardIndex].pronunciation } <
        /div> {
            categoryData[currentCardIndex].meaning ? ( <
                div className = "meaning text-base md:text-lg" >
                <
                span className = "font-semibold" > Meaning: < /span>{" "} { categoryData[currentCardIndex].meaning } <
                /div>
            ) : (
                " "
            )
